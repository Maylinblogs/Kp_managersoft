...
public class UserClaim {
    ...
    @FXML
    private TableColumn<Claim, Date> data;
    ...
    private void initializeTable() {
        ...
        data.setCellValueFactory(data->new SimpleObjectProperty<Date>(data.getValue().getDate_claim()));
    }
    ...
    void onNoClaim(ActionEvent event) throws IOException, ClassNotFoundException {
        ...
        claim.setDate_claim(Date.valueOf(date));
